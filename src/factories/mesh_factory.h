...
public:
  ~MeshFactory();
  RenderComponent make_cube_mesh(ObjectType objectType, glm::vec3 size);
  RenderComponent make_obj_mesh(ObjectType objectType, const char* filename, glm::mat4 preTransform);
